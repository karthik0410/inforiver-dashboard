...
const Toolbar = ({
  ...
  const rows = useSelector((state: any) => state.gridSetting.rows);
  const columns = useSelector((state: any) => state.gridSetting.columns);
  const spacing = useSelector((state: any) => state.gridSetting.spacing);
  const margin = useSelector((state: any) => state.gridSetting.margin);
  const cornerRadius = useSelector((state: any) => state.gridSetting.cornerRadius);
  const stroke = useSelector((state: any) => state.gridSetting.stroke);
  const shadow = useSelector((state: any) => state.gridSetting.shadow);
  const strokeColor = useSelector((state: any) => state.gridSetting.strokeColor);
  const shadowColor = useSelector((state: any) => state.gridSetting.shadowColor);
  const selectedShadow = useSelector(
    (state: any) => state.gridSetting.selectedShadow
  );
